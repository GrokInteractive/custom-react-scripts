...
const cssFilename = process.env.REACT_APP_CSS_FILE_NAME || 'static/css/[name].[contenthash:8].css';
...
module.exports = {
  ...
  output: {
    ...
    filename: process.env.REACT_APP_BUNDLE_FILE_NAME || 'static/js/[name].[chunkhash:8].js',
    chunkFilename: process.env.REACT_APP_BUNDLE_CHUNK_FILE_NAME || 'static/js/[name].[chunkhash:8].chunk.js',
